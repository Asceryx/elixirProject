defmodule Project.ElixirProject do
  @moduledoc """
  The ElixirProject context.
  """
  ...
  def get_workingtime_by_user(id_user, workingtime_id) do
    query = from(wo in Workingtime, where: [id_user: ^id_user, id: ^workingtime_id], select: %{id: wo.id, start: wo.start, end: wo.end})
    Repo.all(query)
  end
